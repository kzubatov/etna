...
public:
  ...
  ShaderProgramSpecializationConstants& operator=(const ShaderProgramSpecializationConstants&) =
    delete;
  ShaderProgramSpecializationConstants(ShaderProgramSpecializationConstants&&) = default;
  ShaderProgramSpecializationConstants& operator=(ShaderProgramSpecializationConstants&&) = default;
